...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Unless it was escaped the astrix would fail to match an astrix
  end
  ...
  #
  # Why?
  # Becuase they collect everything until they are satisfied
  # ------------------------------------------------------------------
  ...
  # The alternation acts like an OR whereas a character class tries to capture everything inside the brackets
